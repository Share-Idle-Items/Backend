...
final case class RegisterInfo(username: String, password: String, front_id: String)
...
class UserSystem extends Actor with ActorLogging {
    ...
    /**
      * login action
      * @param loginInfo login request information
      * @return login result
      */
    ...
    /**
      ...
      * @param credit user credits
      * @param pw user encrypted
